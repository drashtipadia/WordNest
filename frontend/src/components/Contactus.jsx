...
export default function Contactus() {
  ...
  return (
    <div className=" bg-zinc-900 flex py-2.5 items-center justify-center font-sans ">
      <div className=" bg-zinc-800 rounded-lg px-8 py-5 w-full md:w-3/6 lg:w-4/6">
        <p className="text-yellow-100 text-4xl text-center">Conatct Us</p>
        <form className=" mb-4 text-zinc-50 pt-4 px-8" onSubmit={handleSubmit}>
          <div className="mb-4">
