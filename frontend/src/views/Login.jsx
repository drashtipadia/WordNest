...
export const Login=()=> {
  ...
  return (
    <div className="h-screen dark:bg-zinc-900 flex py-2.5 items-center justify-center font-sans ">
      <div className="bg-gray-200 dark:bg-zinc-800 rounded-lg px-8 py-5 w-full md:w-3/6 lg:w-2/6">
        <p className="dark:text-zinc-200 text-4xl text-center">Login</p>

        <form
          className=" mb-4 dark:text-zinc-50 pt-1 px-8"
        ...
        <p className="flex mt-4 items-center dark:text-white justify-center">
          or
        </p>
        <p className="flex mt-4 items-center dark:text-white justify-center">
